...
ncores = 16
ntasks = len(params)
chunksize = ntasks // (ncores - 4)
outfile = "../outputs/confounds_spstruct.json"
...
# deparallelize and see if CARs work better here
for i, _ in enumerate(map(chunk_sim_run, params)):
